...
<html lang="en">
  ...
  <head>
    <meta charset="utf-8">
    <title>Wakavin Bootstrap Template</title>
    ...
    <!-- =======================================================
    Theme Name: Wakavin
    Theme URL: https://bootstrapmade.com/Wakavin-bootstrap-landing-page-template/
    ...
    <header id="header">
      <div class="container">
        ...
        <div id="logo" class="pull-left">
          <h1><a href="#intro" class="scrollto">Wakavin</a></h1>
  ...
  ============================-->
    <section id="intro">
      ...
      <div class="intro-text">
        <h2>Welcome to Wakavin</h2>
        <p>CIPTAKAN MEDIA MU SENDIRI BERSAMA KAMI</p>
        <a href="#about" class="btn-get-started scrollto">HOME</a>
      </div>
        ...
        <div class="container-fluid">
          <div class="section-header">
            ...
            <p class="section-description">
              wakavin merupakan sebuah jasa dan layanan yang bergerak dalam bidang IT
            </p>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-8 offset-lg-4">
              <div class="section-header wow fadeIn" data-wow-duration="1s">
                <h3 class="section-title">LAYANAN JASA</h3>
                <span class="section-divider"></span>
              </div>
            </div>
    ...
    ============================-->
      <section id="more-features" class="section-bg">
        ...
        <div class="title-client text-center">
          ...
          <ul id="faq-list" class="wow fadeInUp">
            ...
            <li>
              <a data-toggle="collapse" href="#faq4" class="collapsed">Ac odio tempor orci dapibus. Aliquam eleifend mi
                in nulla? <i class="ion-android-remove"></i></a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 text-lg-left text-center">
            <div class="copyright">
              &copy; Copyright <strong>Wakavin</strong>. All Rights Reserved
            </div>
            <div class="credits">
              <!--
              ...
              Purchase the pro version with working PHP/AJAX contact form: https://bootstrapmade.com/buy/?theme=Wakavin
            -->
